...
namespace TelemetryApi.Controllers
{
    ...
    public class UploadController : ControllerBase
    {
        ...
        public async Task<IActionResult> Live()
        {
            ...
            if (!HttpContext.Items.TryGetValue("PrivateKey", out var authTokenObj) || authTokenObj is not string authToken)
            {
                return Unauthorized("Private key missing.");
            }
    ...
    .ToHashSet();
            ...
            return Ok($"Uploaded {model.TimeStamp} for {model.Sensors.Count} Sensors");
